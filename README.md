...
As the first line in test_work function sets f(n) = 1, we should expect constant time while when f(n) = log n, the runtime will be logarithmic and when f(n) = n, the runtime will be linear.
...
**TODO: your answer goes here**
  When c < log b, a, the runtime grows but not at an extreme rate. However when c = log b, a and c > log b, a, the runtime grows at a rapid rate, much faster then the first instance.
